...
const sections = [
  ...
  { title: "7. Revisions & Refunds", content: "Every delivery includes up to 2 free revision rounds within 14 days of delivery, limited to the scope agreed at confirmation. New requirements beyond the original scope may warrant a new request. Because payments are final, no refunds are offered; disputes are mediated by the Academic Integrity Office in accordance with our Refund Policy." },
